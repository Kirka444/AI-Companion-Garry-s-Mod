...
function Menu:RegisterPanel()
	...
	-- SetMaximumCharCount ОБЯЗАТЕЛЬНО после SetMultiline, иначе сбросится на 512/255
	promptEntry:SetMaximumCharCount(8000)

	-- Хак: в некоторых билдах GMod лимит сбрасывается при фокусе, поэтому форсируем его в Think
	...
	-- Методы совместимости с RefreshValues
