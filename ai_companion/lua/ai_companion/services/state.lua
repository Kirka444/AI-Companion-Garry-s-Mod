-- Persistent global and per-player state management.
	...
	if not self.storage.Companion then
		...
		self.storage.Companion.ValidTransitions = {
			...
			[States.FOLLOW] = {
				...
				[States.COVER] = true, [States.POINTING] = true, [States.STOPPED] = true,
			},
			[States.COMBAT] = {
				[States.IDLE] = true, [States.FOLLOW] = true, [States.COVER] = true,
				[States.PROTECT] = true, [States.PROTECT_VEHICLE] = true, [States.STOPPED] = true,
			},
			[States.COVER] = {
			...
			[States.SITTING] = {
				[States.FOLLOW] = true, [States.IDLE] = true, [States.VEHICLE] = true,
				[States.STOPPED] = true,
			},
			[States.VEHICLE] = {
