-- Static configuration defaults and provider presets.
...
if SERVER then
	concommand.Add("ai_companion_config_debug", function(ply)
		...
		if IsValid(ply) and not ply:IsAdmin() then
			print("[AI] " .. config:GetLocalized("settings_admin_only"))
			return
		end
		if config then
			config:DebugPrint()
			if IsValid(ply) then
				print("[AI] " .. config:GetLocalized("log_config_debug_console"))
			end
		else
